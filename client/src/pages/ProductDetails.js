...
//   const [unitSet, setUnitSet] = useState(1);
//   const [displayQuantity, setDisplayQuantity] = useState(0);
//   let showQuantitySelector = true; // Declare and initialize the variable
// const [productIds,setProductId]=useState();
//   useEffect(() => {
//     window.scrollTo(0, 0);
...
//       fetchInitialQuantity(data?.product?._id);
//     } catch (error) {
//       console.error(error);
//       toast.error("Error fetching product details");
//     }
...
//       } else {
//         const responseBody = await response.text();
//         _handleApiError('Error removing item', responseBody);
//       }
//     } catch (error) {
...
//    const fetchInitialQuantity = async (productI) => {
//     if (!auth?.user?._id) {
//       toast.error("Please log in to fetch product quantity");
//       return;
//     }
